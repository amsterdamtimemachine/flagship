	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./server/entries/endpoints/api/geodata/_server.ts.js'))
			},
			{
				id: "/api/heatmaps",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./server/entries/endpoints/api/heatmaps/_server.ts.js'))
			},
			{
				id: "/api/histogram",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./server/entries/endpoints/api/histogram/_server.ts.js'))
			},
			{
				id: "/api/metadata",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./server/entries/endpoints/api/metadata/_server.ts.js'))
			},
			{
				id: "/api/test",
				pattern: /^\/api\/test\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./server/entries/endpoints/api/test/_server.ts.js'))
			}
		],
